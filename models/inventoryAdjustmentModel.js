  ...
  try {
    ...
    for (const adj of adjustments) {
      ...
      await client.query(
        ...
        VALUES ($1, $2, $3, $4, $5, $6)
      `,
        [productId, locationId, adjustmentDate, quantityChange, reason, userId]
      );
      ...
      `,
        [productId, locationId, quantityChange, `ADJUSTMENT#${reason || ""}`]
      );
...
export const getInventoryAdjustmentsByFilter = async ({
  startDate,
  endDate,
  productId,
}) => {
